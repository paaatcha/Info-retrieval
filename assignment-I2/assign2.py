...
# Saving the values' mean
column_mean = dataMatrix.mean(axis=0)
row_mean = dataMatrix.mean(axis=1)

print 'Saving the files row-mean.dat and column-mean.dat...'
np.savetxt('row-mean.dat', row_mean)
np.savetxt('column-mean.dat', column_mean.reshape(1,37))
